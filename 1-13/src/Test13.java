	...
	public static void main(String[] args) {
		...
		for(int i = 2 ; i < strArray1.size() ; i++) {
			...
			for(int a = 0; a < strArray2.size(); a++) {
				...
				for(int y = 0; y < strArray3.size(); y++) {
					if(strArray3.get(y).equals("k") && strArray4.size() == 0 ) {
						strArray4.add(strArray3.get(y));
					}else if(strArray3.get(y).equals("a") && strArray4.size() == 1 ) {
						strArray4.add(strArray3.get(y));
					}else if(strArray3.get(y).equals("k") && strArray4.size() == 2 ) {
						strArray4.add(strArray3.get(y));
					}else if(strArray3.get(y).equals("a") && strArray4.size() == 3 ) {
						strArray4.add(strArray3.get(y));
					}else if(strArray3.get(y).equals("o") && strArray4.size() == 4 ) {
						strArray4.add(strArray3.get(y));
					}
